...
2. Personalizar las imágenes (los textos), les dejo las dos plantillas realizadas en CANVA<br/>
...
3. Una vez hayas realizado estas modificaciones ya puedes presentar tu web, para visualizarlo simplemente abre el archivo HTML haciendo doble click sobre él o utilizando alguna extensión de VSC.
4. ¡Suerte! Espero que tu Cita de San Valentín sea perfecta.
...
2. Personalize the images (texts). I've provided two templates created in CANVA:  
...
3. Once you've made these modifications, you can present your website. To view it, simply open the HTML file by double-clicking on it or using a VSC extension.
4. Good luck! I hope your Valentine's Day goes perfectly.
